...
describe('Shipment e2e test', () => {
  ...
  const shipmentSample = { date: '2023-01-17T15:16:00.261Z' };
  ...
  describe('new Shipment page', () => {
    ...
    it('should create an instance of Shipment', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2023-01-17T16:41').blur().should('have.value', '2023-01-17T16:41');

      cy.get(`[data-cy="details"]`).type('withdrawal Superviseur a').should('have.value', 'withdrawal Superviseur a');
