...
describe('Invoice e2e test', () => {
  ...
  const invoiceSample = {
    date: '2023-01-18T07:45:33.470Z',
    status: 'PAID',
    paymentMethod: 'PAYPAL',
    paymentDate: '2023-01-18T06:42:04.622Z',
    paymentAmount: 4928,
  };
  ...
  describe('new Invoice page', () => {
    ...
    it('should create an instance of Invoice', () => {
      cy.get(`[data-cy="date"]`).type('2023-01-17T20:15').blur().should('have.value', '2023-01-17T20:15');
      ...
      cy.get(`[data-cy="paymentDate"]`).type('2023-01-18T02:43').blur().should('have.value', '2023-01-18T02:43');
